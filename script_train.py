...
for num in range(0, 20):
    ...
    os.system(
        'cp expt_settings/outputs/saved_models/icemonly/fixed/TemporalFusionTransformer.ckpt.data-00000-of-00001 save/' + str(
            num) + '/TemporalFusionTransformer.ckpt.data-00000-of-00001')
    os.system(
        'cp expt_settings/outputs/saved_models/icemonly/fixed/TemporalFusionTransformer.ckpt.index save/' + str(
            num) + '/TemporalFusionTransformer.ckpt.index')
    os.system(
        'cp expt_settings/outputs/saved_models/icemonly/fixed/TemporalFusionTransformer.ckpt.meta save/' + str(
            num) + '/TemporalFusionTransformer.ckpt.meta')
