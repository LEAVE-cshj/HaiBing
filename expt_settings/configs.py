...
import data_formatters.icemonly
...
class ExperimentConfig(object):
  ...
  default_experiments = ['ice','icemonly']
  ...
  @property
  #ice_monlymuti2022 jra55
  def data_csv_path(self):
    csv_map = {
        'ice': 'ice_data.csv',
        'icemonly': 'sienew.csv'#sienew.csv
    }
  ...
  def hyperparam_iterations(self):
    ...
    return 240 if self.experiment == 'volatility' else 30
